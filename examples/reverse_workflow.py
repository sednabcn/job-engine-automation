...
def main():
    ...
    print(f"Total Sprints: {plan.get('total_sprints', 0)}")
    ...
    sprint = engine.start_sprint(
        skills=["PyTorch", "Docker"], project_goal="Build and containerize a simple ML model"
    )
    print(f"Sprint ID: {sprint.get('sprint_id', 'N/A')}")
