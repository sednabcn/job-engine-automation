...
class GitHubActionsAutomation:
    ...
    def run_automated_analysis(self, cv_path: str, job_path: str, config: Dict[str, Any] = None) -> Dict[str, Any]:
        """
            ...
            'jobs': {
                'analyze': {
                    ...
                    'steps': [
                        ...
                        {
                            'name': 'Run analysis',
                            'run': 'python examples/automation_example.py'
                        },
                        {
                            'name': 'Upload results',
    ...
    def _calculate_match(self, candidate: Dict, job: Dict) -> Dict[str, Any]:
        ...
        if overall_score >= 85:
            ...
            recommendation = "CONSIDER SKILL DEVELOPMENT"
            ...
            'sprints': [
                {
                    'sprint': 1,
                    'duration_weeks': 2,
                    'skills': match_results['missing_skills'][:2] if match_results['missing_skills'] else [],
                    'hours': 40
                }
            ]
        }
...
def main():
    ...
    print(f"✅ Workflow configured for weekly Monday 9am analysis")
