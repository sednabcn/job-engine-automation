...
"""
        ...
        skill_sets = {
            ...
            "medium": [
                ...
                "Git", "AWS", "Linux", "REST APIs", "GraphQL"
            ],
            "complex": [
                ...
                "Linux", "Nginx", "REST APIs", "GraphQL", "gRPC",
...
"""
    ...
    def generate_summary(self):
        ...
        self.results['summary'] = {
            'total_iterations': self.iterations * (len(self.results['cv_parsing']) + 
                                                  len(self.results['job_parsing'])),
            'cv_parsing': {
