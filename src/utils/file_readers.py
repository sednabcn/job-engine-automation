...
class PDFReader:
    ...
    def read(file_path: str) -> str:
        ...
        try:
            ...
            raise ImportError(
                "PyPDF2 is required for PDF reading. "
...
class JobDescriptionReader(FileReader):
    ...
    def read_job(file_path: str) -> Dict[str, Any]:
        ...
        return {
            ...
            'has_requirements': 'requirements' in content.lower() or 'qualifications' in content.lower(),
            'has_responsibilities': 'responsibilities' in content.lower() or 'duties' in content.lower()
        }
